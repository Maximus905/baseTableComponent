...
describe('test changing of filter settings', () => {
    test('change filter type  EQ -> NE', () => {
        let filtersSettings = {
    ...
    test('change filter type EQ -> LIST', () => {
        let filtersSettings = {
            c1: getFilterSettings('c1', 'EQ', ['EQ', 'LIST']),
            c2: getFilterSettings('c2', 'LIST', ['EQ', 'LIST'])
        }
...
describe('change filter types and check filter state', () => {
    test('change type EQ -> NE. Not empty value in EQ', () => {
        let filters = {
    ...
    test('change type EQ -> NE. Empty value in EQ', () => {
        let filters = {
    ...
    test('change type EQ -> LIST. Not empty value in EQ', () => {
        let filters = {
            c1: getTextFilterState('c1', 'EQ', ['v1', 'v2'], false),
            c2: getListFilterState('c2', 'LIST', false, ['v1', 'v2'], ['l1', 'l2'], false)
        }
...
describe('change value of filter with filters_changeValue and test state of filters', () => {
    ...
    test('filters, change value, LIST type of filter', () => {
        let filters = {
            c1: getListFilterState('c1', 'LIST', false, ['v1', 'v2'], ['l1', 'l2'], false),
            c2: getListFilterState('c2', 'LIST', false, ['v1', 'v2'], ['l1', 'l2'], false)
        }
        let result = {
            c1: getListFilterState('c1', 'LIST', false, ['newValue'], ['l1', 'l2'], false),
            c2: getListFilterState('c2', 'LIST', false, ['v1', 'v2'], ['l1', 'l2'], true)
        }
        expect(filters_changeValue({filters: filters, accessor: 'c1', value: ['newValue'], selectAllState: false})).toEqual(result)
    })
...
describe('change value or type of filter with app_changeFilter and check parts of state', () => {
    test('change type EQ -> NE, not empty value', () => {
        let filters = {
            c1: getTextFilterState('c1', 'EQ', ['v1', 'v2'], false),
            c2: getListFilterState('c2', 'LIST', false, ['v1', 'v2'], ['l1', 'l2'], false)
        }
    ...
    test('change type EQ -> NE, empty value', () => {
        let filters = {
            c1: getTextFilterState('c1', 'EQ', [], false),
            c2: getListFilterState('c2', 'LIST', false, ['v1', 'v2'], ['l1', 'l2'], false)
        }
    ...
    test('change type EQ -> LIST, not empty value', () => {
        let filters = {
            c1: getTextFilterState('c1', 'EQ', ['v1', 'v2'], false),
            c2: getListFilterState('c2', 'LIST', false, ['v1', 'v2'], ['l1', 'l2'], false)
        }
    ...
    test('change type EQ -> LIST, empty value', () => {
        let filters = {
            c1: getTextFilterState('c1', 'EQ', [], false),
            c2: getListFilterState('c2', 'LIST', false, ['v1', 'v2'], ['l1', 'l2'], false)
        }
...
describe('behaviours of LIST filter', () => {
    test('set LIST filter in loading state', () => {
        const filters = {
    ...
    test('receive data for LIST filter', () => {
...
describe('convert filters state for sending to server', () => {
    test('LIST filters, selectAll, no empty value', () => {
        const filters = {
    ...
    test('LIST filters, selectAll, empty value', () => {
        const filters = {
    ...
    test('LIST filters, no selectAll, no empty value', () => {
        const filters = {
    ...
    test('LIST filters, no selectAll, empty value', () => {
        const filters = {
