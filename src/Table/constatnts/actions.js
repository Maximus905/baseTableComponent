...
export const CHANGE_ROWS_ON_PAGE = 'CHANGE_ROWS_ON_PAGE'
...
export const FINISH_EDIT_CELL = 'FINISH_EDIT_CELL'
export const SAVE_DATA_LOCAL = 'SAVE_DATA_LOCAL'
export const SAVE_DATA_ON_SERVER = 'SAVE_DATA_ON_SERVER'
export const SAVING_EDIT_RESULT = 'SAVING_EDIT_RESULT'
